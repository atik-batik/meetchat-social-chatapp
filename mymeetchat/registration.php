...
<br />
<br />
<!-- <form  method="post" action="/myaction.php" name="myForm" onsubmit="return validateForm()"> -->
...
<input type="submit" value="Register Me" class="commandButton" onclick="return confirm('Please check everything before submitting');" />
<!-- <i class="far fa-paper-plane"> </i> -->
<span class="loading-anim"> </span></td></tr>
</table>
</form>
<br />
